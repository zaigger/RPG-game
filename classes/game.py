...
class persons:
    ...
    def choose_item(self):
        ...
        for item in self.items:
            print("        " + str(i) + ".", item["item"].name + ":", item["item"].discription, "(x" + str(item["quantity"]))
            i += 1
    ...
    def choose_enemy_spell(self):
        ...
        prcnt = self.hp / self.maxhp * 100
        if self.mp < spell.cost or spell.type == "white" and prcnt > 50:
